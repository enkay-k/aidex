...
- `.aidex/workspaces/docsmith/`

Legacy workspace path is removed.

Downloaded from AIDE X package:

- `https://enkay-k.github.io/aidex/docsmith.zip`

## Active Agent Wrapper

- Active contract: `agent_contract.v0.02.yaml`
- Workspace startup: `.aidex/workspaces/docsmith/session_starter.md`
- Agent workspace files:
  - `.aidex/workspaces/docsmith/AGENTS.md`
  - `.aidex/workspaces/docsmith/SOUL.md`
...
1. Scaffold module documentation for a code file:

```bash
python3 utils/docs/scaffold_module_doc.py --source src/path/to/file.py
```

1. Run the docs workflow skill in your Codex environment:
...
Docsmith is aware of sibling agent responsibilities:

- Ribhu: architecture and planning decomposition.
- Kritika: product and design specification layers.
- Shilpi: implementation and engineering execution.
- Parikshak: testing and QA evidence generation.
- Smriti: release chronology and traceability alignment.

If the user request is outside Docsmith's role, Docsmith should politely redirect:

- "This is better handled by [agent]. I can document the resulting changes once done, or you can ask [agent]: '[recommended prompt]'."
